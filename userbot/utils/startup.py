    ...
    try:
        if BOTLOG:
            Config.CATUBLOGO = await catub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph/file/3a58d68544dd3c80fcdb2.jpg",
                caption="**Your AssistanT has been started successfully.**",
                buttons=[(Button.url("Ma-LinkZ", "https://t.me/PrimeFlixMedia_All"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
